...
As seen in Figure&nbsp;\@ref(fig:example-profile), this profile of scores is summarized by a composite score of `r formatC(d$X_Composite, 2, format = "f")`.
...
However, I think it best to sidestep all this complication of converting covariances to correlations with the `cov2cor` function:
